...
const SemesterTable = ( { semester_id, setSemesterName } ) => {
  ...
  useEffect(() => {
    const fetchSubject = async () => {
      try {
        const response = await apiAuth("/student/semester/info/" + semester_id);
        ...
        <table className="student-view-table">
          <thead className="student-view-table-header">
            <tr>
              ...
              <th className="student-view-table-header-cell">Įskaitос požymис</th>
...
const StudentView = () => {
  ...
  useEffect(()=>{
    const fetchStudentData = async () => {
      try {
        const infoMe = await apiAuth("/student/info/me");
